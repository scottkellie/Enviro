var fs = require('fs'), http = require('http'), five = require('johnny-five'), board, repl = require("repl"), socketio = require('socket.io');
...
var server = http.createServer(function (req, res) {
		...
		board.on("ready", function () {
			...
			relay1 = new five.Led(12);
			this.repl.inject({
				relayC : relay3
			});
			relay4 = new five.Led(13);
			this.repl.inject({
				relayD : relay4
			});
			led5 = new five.Led(5);
